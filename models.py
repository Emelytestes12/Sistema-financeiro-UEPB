...
class Gasto:
    # ==================== ALTERAÇÃO 2 (INÍCIO) ====================  #ok
    # data=None é opcional para novos gastos (a data é criada automaticamente no banco).
    # Serve para quando formos CARREGAR do banco de dados os gastos antigos.
